...
public class StaticGlobalVariableExample3 {
	...
	//static global  variables
		...
		System.out.println("default value of age is " +StaticGlobalVariableExample3.res );
		System.out.println("default value of age is " +StaticGlobalVariableExample3.grade);
		System.out.println("default value of age is " +StaticGlobalVariableExample3.roi);
		System.out.println("**********************************");
		//initialization of static global variable
		StaticGlobalVariableExample3.age=25;
		StaticGlobalVariableExample3.res=true;
		StaticGlobalVariableExample3.grade='N';
		StaticGlobalVariableExample3.roi=1.2f;
